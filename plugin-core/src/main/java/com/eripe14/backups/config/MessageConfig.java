...
public class MessageConfig extends OkaeriConfig {
    ...
    @CustomKey("backup-already-granted")
    public BukkitNotice backupAlreadyGranted = BukkitNotice.chat("&cTen backup został już przyznany!");

    @CustomKey("empty-inventory-required")
    public BukkitNotice emptyInventoryRequired = BukkitNotice.chat("&cAby to zrobic, musisz miec puste inventory!");

    @CustomKey("receive-backup")
    public BukkitNotice receivedBackup = BukkitNotice.chat("&a&lOdebrałeś backup!");

    @CustomKey("you-have-backups-to-receive")
    public BukkitNotice youHaveBackupsToReceive = BukkitNotice.title("&c&nMasz backup do obioru!");

    @CustomKey("granted-backup")
    public BukkitNotice grantedBackup = BukkitNotice.chat("&aBackup zostal nadany!");
